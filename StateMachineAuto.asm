...
setinal      EQU    0X23 
portc        EQU    0x24            ; Shadow portc
State        EQU    0x25
portb		 EQU    0x26			; Shadow portb	
COUNT        EQU    0x27
...
main
	...
	BANKSEL   INTCON
	MOVLW     0xC0            ; Place 10100000 into INTCON  - Set the Timer0 Overflow Interupt and enables GIE
	MOVWF     INTCON 	
	BANKSEL   T1CON
	...
	BANKSEL ANSEL   	 ; Select the analog select register
	CLRF    ANSEL        ; Clear register
	BANKSEL ANSELH
	CLRF	ANSELH	     ; Clear register
	BANKSEL TRISB	
	CLRF    TRISB
	BANKSEL TRISC	     ;Selects the correct bank for register
	CLRF    TRISC	     ;Make Port C an output only
	BANKSEL PORTC        ; Gets to Port C bank
    CLRF    PORTC        ; Clear
	MOVLW   D'1'         ; Placing Value in State
    MOVWF   State
